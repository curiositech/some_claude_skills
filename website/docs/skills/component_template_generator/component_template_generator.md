---
sidebar_label: Component Template Generator
sidebar_position: 1
---
...
`components` `react` `vue` `svelte` `templates`
...
- [Component Catalog Reference](./references/component-catalog)
- [Component Patterns by Trend](./references/component-patterns)
