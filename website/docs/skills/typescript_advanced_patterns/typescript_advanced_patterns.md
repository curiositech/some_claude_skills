---
sidebar_label: Typescript Advanced Patterns
sidebar_position: 1
---
...
```
Read, Write, Edit, Bash(npm:*, npx:*, tsc:*)
```

## Tags

`typescript` `type-system` `branded-types` `generics` `zod`

## 🤝 Pairs Great With

- **[Api Architect](/docs/skills/api_architect)**: Type-safe API contracts with Zod
- **[Vitest Testing Patterns](/docs/skills/vitest_testing_patterns)**: Type-level testing with expect-type
- **[React Performance Optimizer](/docs/skills/react_performance_optimizer)**: Type-safe React patterns

## References

- [Branded Types Reference](./references/branded-types)
- [Type-Safe Patterns Reference](./references/type-safe-patterns)
