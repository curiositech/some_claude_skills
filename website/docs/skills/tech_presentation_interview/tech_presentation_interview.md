---
sidebar_label: Tech Presentation Interview
sidebar_position: 1
---
...
- **[Interview Loop Strategist](/docs/skills/interview_loop_strategist)**: Upstream orchestrator that routes to this skill for presentation rounds
- **[Ml System Design Interview](/docs/skills/ml_system_design_interview)**: Complementary -- this presents real systems, that designs hypothetical ones
- **[Hiring Manager Deep Dive](/docs/skills/hiring_manager_deep_dive)**: Similar depth-testing but conversational rather than presentational
- **[Career Biographer](/docs/skills/career_biographer)**: Upstream -- extracts the raw project narratives this skill structures
- **[Interview Simulator](/docs/skills/interview_simulator)**: Runs timed mock presentations with realistic Q&A scoring

## References

- [Project Narrative Template](./references/project-narrative-template)
- [Whiteboard Diagrams for Technical Presentations](./references/whiteboard-diagrams)
