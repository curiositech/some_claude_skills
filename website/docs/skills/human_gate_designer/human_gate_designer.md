---
sidebar_label: Human Gate Designer
sidebar_position: 1
---
...
- **[Task Decomposer](/docs/skills/task_decomposer)**: Task decomposition identifies which DAG nodes require human approval gates
- **[Output Contract Enforcer](/docs/skills/output_contract_enforcer)**: Human gate inputs and outputs need schema validation before routing decisions
- **[Reactflow Expert](/docs/skills/reactflow_expert)**: Human gates are visualized as interactive approval nodes in DAG dashboards
