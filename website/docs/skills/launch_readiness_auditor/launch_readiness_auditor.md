---
sidebar_label: Launch Readiness Auditor
sidebar_position: 1
---
...
- **[Checklist Discipline](/docs/skills/checklist_discipline)**: Launch readiness assessment is a systematic checklist application for production deployments
- **[Security Auditor](/docs/skills/security_auditor)**: Security audit is a critical gate in any launch readiness evaluation
- **[Test Automation Expert](/docs/skills/test_automation_expert)**: Test coverage and CI pass rates are key launch readiness metrics
- **[Feature Manifest](/docs/skills/feature_manifest)**: Feature manifests track which features are complete and ready for launch
