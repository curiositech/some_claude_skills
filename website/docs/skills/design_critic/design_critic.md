...
`aesthetics` `critique` `scoring` `remix` `visual-quality` `assessment` `design-review`

## 🤝 Pairs Great With

- **[Web Design Expert](/docs/skills/web_design_expert)**: Complementary skill
- **[Color Contrast Auditor](/docs/skills/color_contrast_auditor)**: Complementary skill
- **[Frontend Architect](/docs/skills/frontend_architect)**: Complementary skill
- **[Design System Generator](/docs/skills/design_system_generator)**: Complementary skill
- **[Vibe Matcher](/docs/skills/vibe_matcher)**: Complementary skill

## References

- [Assessment Rubric](./references/assessment-rubric)
- [Pattern Scoring](./references/pattern-scoring)
- [Remix Patterns](./references/remix-patterns)
- [Remix Strategies](./references/remix-strategies)
- [Taste Calibration](./references/taste-calibration)
