---
sidebar_label: Hiring Manager Deep Dive
sidebar_position: 1
---
...
`interview` `hiring-manager` `leadership` `staff-engineer` `scope`

## 🤝 Pairs Great With

- **[Interview Loop Strategist](/docs/skills/interview_loop_strategist)**: Coordinates this round within full interview loop preparation
- **[Values Behavioral Interview](/docs/skills/values_behavioral_interview)**: Overlapping behavioral questions require consistent story bank
- **[Tech Presentation Interview](/docs/skills/tech_presentation_interview)**: Technical narrative framing carries across both rounds
- **[Career Biographer](/docs/skills/career_biographer)**: Upstream -- extracts raw career material this skill structures for HM
- **[Interview Simulator](/docs/skills/interview_simulator)**: Mock HM rounds with realistic follow-up pressure

## References

- [Project Impact Calculator](./references/project-impact-calculator)
- [Staff-Level Signals: What Hiring Managers Actually Evaluate](./references/staff-level-signals)
