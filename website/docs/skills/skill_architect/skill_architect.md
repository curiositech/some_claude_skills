...
- **[Skill Creator](/docs/skills/skill_creator)**: The architect designs skill structure; the creator guides implementation following those patterns
- **[Skill Grader](/docs/skills/skill_grader)**: Grading feedback identifies architectural weaknesses that the architect addresses
- **[Skill Coach](/docs/skills/skill_coach)**: Coaching guides quality improvement using the architectural patterns the architect defines
- **[Skill Documentarian](/docs/skills/skill_documentarian)**: Documentation standards complement architectural design for complete skill delivery

## References

- [Skill Anti-Patterns: The Shibboleths](./references/antipatterns)
- [Claude Extension Taxonomy: Skills, Plugins, MCPs, Hooks, Agent SDK](./references/claude-extension-taxonomy)
- [Skill Description Writing Guide](./references/description-guide)
- [Knowledge Engineering for Skill Creation](./references/knowledge-engineering)
- [Minimal MCP Server Template](./references/mcp-template)
- [Plugin Architecture: Creating, Packaging, and Distributing](./references/plugin-architecture)
- [Self-Contained Tools](./references/self-contained-tools)
- [Designing Skills for Subagent Consumption](./references/subagent-design)
- [Subagent Definition Template](./references/subagent-template)
- [Visual Artifacts in Skills: Mermaid Diagrams & Code](./references/visual-artifacts)
