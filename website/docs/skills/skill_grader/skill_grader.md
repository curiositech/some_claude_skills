...
- **[Skill Architect](/docs/skills/skill_architect)**: Grading reveals architectural gaps that the architect addresses with structural improvements
- **[Skill Creator](/docs/skills/skill_creator)**: Grading feedback guides creators on which quality axes need improvement
- **[Skill Coach](/docs/skills/skill_coach)**: Grading provides objective scores that coaching uses to prioritize improvement areas
