---
sidebar_label: National Expungement Expert
sidebar_position: 1
---
...
`expungement` `criminal-records` `legal` `clean-slate`

## 🤝 Pairs Great With

- **[2026 Legal Research Agent](/docs/skills/2026_legal_research_agent)**: The research agent finds raw statute data that the expungement expert interprets for eligibility
- **[Document Generation Pdf](/docs/skills/document_generation_pdf)**: Expungement filings require automated court form PDF generation
- **[Design Justice](/docs/skills/design_justice)**: Expungement tools serve marginalized populations requiring equitable, accessible design

## References

- [State Eligibility Matrix](./references/state-eligibility-matrix)
