---
sidebar_label: Fancy Yard Landscaper
sidebar_position: 1
---
...
`landscaping` `garden` `plants` `outdoor` `privacy-screen`

## 🤝 Pairs Great With

- **[Interior Design Expert](/docs/skills/interior_design_expert)**: Indoor-outdoor design cohesion
- **[Maximalist Wall Decorator](/docs/skills/maximalist_wall_decorator)**: Bold outdoor aesthetic choices

## References

- [Privacy Screen Plant Guide](./references/privacy-screens)
