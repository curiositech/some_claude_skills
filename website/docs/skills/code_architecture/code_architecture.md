...
`code` `architecture` `clean-architecture` `hexagonal-architecture` `feature-based-structure`

## 🤝 Pairs Great With

- **[Refactoring Surgeon](/docs/skills/refactoring_surgeon)**: Refactoring implements the architectural patterns that code-architecture prescribes
- **[Monorepo Management](/docs/skills/monorepo_management)**: Monorepo workspace boundaries enforce architectural module separation
- **[Microservices Patterns](/docs/skills/microservices_patterns)**: Service decomposition decisions depend on application architecture patterns
- **[Typescript Advanced Patterns](/docs/skills/typescript_advanced_patterns)**: TypeScript type system features enforce architectural boundaries at compile time

## References

- [Architecture Patterns Deep Dive](./references/architecture-patterns)
- [Dependency Inversion — IoC Containers and Injection Patterns](./references/dependency-inversion)
