---
sidebar_label: Logging Observability
sidebar_position: 1
---
...
```
Read, Write, Edit, Bash(npm:*, npx:*, pip:*, docker:*)
```

## Tags

`observability` `logging` `tracing` `metrics` `opentelemetry` `monitoring`

## 🤝 Pairs Great With

- **[Api Architect](/docs/skills/api_architect)**: API request tracing and correlation IDs
- **[Devops Automator](/docs/skills/devops_automator)**: Deploying collectors and dashboards
- **[Background Job Orchestrator](/docs/skills/background_job_orchestrator)**: Distributed job observability

## References

- [Alerting Patterns Reference](./references/alerting-patterns)
- [OpenTelemetry Setup Reference](./references/opentelemetry-setup)
