---
sidebar_label: Design System Generator
sidebar_position: 1
---
...
- **[Design System Creator](/docs/skills/design_system_creator)**: Generator creates initial tokens and themes; creator builds the full component library from them
- **[Design System Documenter](/docs/skills/design_system_documenter)**: Generated design systems need comprehensive documentation for team adoption
- **[Component Template Generator](/docs/skills/component_template_generator)**: Design tokens from the generator feed into component template scaffolding
- **[Typography Expert](/docs/skills/typography_expert)**: Type scale and font pairing decisions are foundational to design system generation

## References

- [Accessibility in Generated Design Systems](./references/accessibility)
- [Advanced CSS Techniques Reference](./references/advanced-css-techniques)
- [DesignPrompts AI-Ready Styles Reference](./references/design-prompts-styles)
- [Output Formats Reference](./references/output-formats)
- [Design Trend Mapping Reference](./references/trend-mapping)
