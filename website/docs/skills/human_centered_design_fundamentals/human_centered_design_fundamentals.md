---
sidebar_label: Human Centered Design Fundamentals
sidebar_position: 1
---
...
- **[Ux Friction Analyzer](/docs/skills/ux_friction_analyzer)**: UX friction analysis applies human-centered design principles to identify usability barriers
- **[Adhd Design Expert](/docs/skills/adhd_design_expert)**: ADHD-aware design is a specialized application of human-centered design for neurodivergent users
- **[Design Justice](/docs/skills/design_justice)**: Design justice extends human-centered design to explicitly center marginalized communities
