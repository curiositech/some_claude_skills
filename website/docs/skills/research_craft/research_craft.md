...
- **[Research Analyst](/docs/skills/research_analyst)**: Research craft provides the methodology that research analysis applies to specific domains
- **[Technical Writer](/docs/skills/technical_writer)**: Research findings are communicated through technical writing with proper citations
- **[Munger Worldly Wisdom](/docs/skills/munger_worldly_wisdom)**: Mental model frameworks complement systematic research methodology for deeper analysis
...
## When to Use
✅ Use for: Academic research papers, thesis/dissertation work, scholarly article writing, literature reviews, evidence-based argumentation, knowledge synthesis, participating in disciplinary conversations
❌ NOT for: Creative writing, journalistic reporting, business case studies, technical documentation, marketing content, personal essays, opinion pieces
