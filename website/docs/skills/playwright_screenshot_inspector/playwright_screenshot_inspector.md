---
sidebar_label: Playwright Screenshot Inspector
sidebar_position: 1
---
...
`playwright` `visual-testing` `screenshots` `ui-verification` `automation`

## 🤝 Pairs Great With

- **[Playwright E2e Tester](/docs/skills/playwright_e2e_tester)**: Visual regression testing extends E2E test suites with screenshot comparison
- **[Webapp Testing](/docs/skills/webapp_testing)**: Screenshot inspection automates the visual verification that interactive testing does manually
- **[Color Contrast Auditor](/docs/skills/color_contrast_auditor)**: Automated screenshot analysis can detect contrast violations across UI states
