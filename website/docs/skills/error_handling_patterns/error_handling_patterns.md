...
`error` `handling` `patterns` `error-handling` `exception-hierarchy`

## 🤝 Pairs Great With

- **[Typescript Advanced Patterns](/docs/skills/typescript_advanced_patterns)**: Result/Either types and discriminated unions implement type-safe error handling in TS
- **[Logging Observability](/docs/skills/logging_observability)**: Structured error logging with correlation IDs enables effective error tracking and debugging
- **[Background Job Orchestrator](/docs/skills/background_job_orchestrator)**: Retry patterns and dead letter queues are error handling applied to job processing

## References

- [Error Hierarchy Examples](./references/error-hierarchy-examples)
- [Retry Patterns Reference](./references/retry-patterns)
