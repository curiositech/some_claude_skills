---
sidebar_label: Interview Loop Strategist
sidebar_position: 1
---
...
`interview` `preparation` `strategy` `anthropic`

## 🤝 Pairs Great With

- **[Senior Coding Interview](/docs/skills/senior_coding_interview)**: Handles coding round preparation and practice
- **[Ml System Design Interview](/docs/skills/ml_system_design_interview)**: Handles ML system design round deep practice
- **[Anthropic Technical Deep Dive](/docs/skills/anthropic_technical_deep_dive)**: Handles Anthropic-specific technical deep dive rounds
- **[Tech Presentation Interview](/docs/skills/tech_presentation_interview)**: Handles technical presentation round preparation
- **[Values Behavioral Interview](/docs/skills/values_behavioral_interview)**: Handles behavioral and values-fit round preparation
- **[Hiring Manager Deep Dive](/docs/skills/hiring_manager_deep_dive)**: Handles hiring manager screen preparation
- **[Interview Simulator](/docs/skills/interview_simulator)**: Runs mock interviews with realistic evaluation
- **[Career Biographer](/docs/skills/career_biographer)**: Upstream -- extracts career narrative raw material
- **[Cv Creator](/docs/skills/cv_creator)**: Upstream -- resume must be finalized before loop begins

## References

- [Company-Specific Interview Loops](./references/company-specific-loops)
- [Mock Interview Rubrics](./references/mock-interview-rubrics)
- [Preparation Timeline Templates](./references/preparation-timeline-templates)
