---
sidebar_label: Interview Simulator
sidebar_position: 1
---
...
- **[Interview Loop Strategist](/docs/skills/interview_loop_strategist)**: Upstream orchestrator -- strategist decides WHAT to practice, simulator executes HOW
- **[Senior Coding Interview](/docs/skills/senior_coding_interview)**: Provides coding round content, problem archetypes, and scoring rubrics
- **[Ml System Design Interview](/docs/skills/ml_system_design_interview)**: Provides ML design problems, whiteboard evaluation criteria, 7-stage framework
- **[Anthropic Technical Deep Dive](/docs/skills/anthropic_technical_deep_dive)**: Provides Anthropic-specific technical topics and opinion evaluation
- **[Tech Presentation Interview](/docs/skills/tech_presentation_interview)**: Provides presentation structure, Q&A stress testing, and audience calibration
- **[Values Behavioral Interview](/docs/skills/values_behavioral_interview)**: Provides behavioral story bank, follow-up ladder depth, STAR-L format
- **[Hiring Manager Deep Dive](/docs/skills/hiring_manager_deep_dive)**: Provides HM round structure, scope-of-impact evaluation, leadership signals

## References

- [Mobile App Architecture](./references/mobile-app-architecture)
- [Proctor Engine Setup](./references/proctor-engine-setup)
- [Session Orchestration](./references/session-orchestration)
- [Voice Engine Setup](./references/voice-engine-setup)
- [Whiteboard Engine Setup](./references/whiteboard-engine-setup)
