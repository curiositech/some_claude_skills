...
- **[Cost Optimizer](/docs/skills/cost_optimizer)**: Model routing is the primary mechanism for implementing cost optimization decisions
- **[Cost Accrual Tracker](/docs/skills/cost_accrual_tracker)**: Real-time cost data informs routing decisions to stay within budget constraints
- **[Prompt Engineer](/docs/skills/prompt_engineer)**: Prompt complexity analysis determines which model tier the router should select
