---
sidebar_label: Pixel Art Scaler
sidebar_position: 1
---
...
- **[Win31 Pixel Art Designer](/docs/skills/win31_pixel_art_designer)**: Pixel art assets created by the designer need proper upscaling for high-DPI displays
- **[Pixel Art Infographic Creator](/docs/skills/pixel_art_infographic_creator)**: Pixel art infographics need deterministic scaling to preserve sharp edges at larger sizes
- **[Native App Designer](/docs/skills/native_app_designer)**: App icon scaling from pixel art originals requires pattern-aware upscaling algorithms
