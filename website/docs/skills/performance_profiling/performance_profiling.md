...
`performance` `profiling` `performance-bottleneck` `flame-graph`

## 🤝 Pairs Great With

- **[React Performance Optimizer](/docs/skills/react_performance_optimizer)**: React DevTools profiling identifies component re-render bottlenecks for optimization
- **[Caching Strategies](/docs/skills/caching_strategies)**: Profiling reveals cache miss patterns that inform caching architecture decisions
- **[Postgresql Optimization](/docs/skills/postgresql_optimization)**: Database query profiling with EXPLAIN ANALYZE identifies slow query bottlenecks
- **[Logging Observability](/docs/skills/logging_observability)**: Performance metrics and traces collected by observability systems feed profiling analysis

## References

- [Browser Profiling Reference](./references/browser-profiling)
- [Node.js Profiling Reference](./references/node-profiling)
