...
- **[Cost Accrual Tracker](/docs/skills/cost_accrual_tracker)**: The tracker provides the real-time cost data that the optimizer uses for budget decisions
- **[Llm Router](/docs/skills/llm_router)**: Model routing is the primary mechanism through which cost optimization is enacted
- **[Cost Verification Auditor](/docs/skills/cost_verification_auditor)**: Post-execution auditing validates that optimization decisions actually reduced costs
