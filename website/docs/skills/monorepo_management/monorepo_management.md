...
- **[Dependency Management](/docs/skills/dependency_management)**: Workspace-level dependency hoisting and version alignment are monorepo-specific challenges
- **[Git Workflow Expert](/docs/skills/git_workflow_expert)**: Monorepo git strategies (sparse checkout, path-based triggers) differ from single-repo workflows
- **[Github Actions Pipeline Builder](/docs/skills/github_actions_pipeline_builder)**: Monorepo CI requires path-filtered workflows and build caching across workspaces
- **[Code Architecture](/docs/skills/code_architecture)**: Module boundaries and dependency direction rules define monorepo workspace structure

## References

- [Turborepo Patterns Reference](./references/turborepo-patterns)
- [Workspace Architecture Reference](./references/workspace-architecture)
