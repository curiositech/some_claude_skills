...
- **[Security Auditor](/docs/skills/security_auditor)**: Dependency vulnerability scanning is a critical security audit dimension
- **[Monorepo Management](/docs/skills/monorepo_management)**: Monorepo workspace dependency hoisting and version alignment require specialized management
- **[Devops Automator](/docs/skills/devops_automator)**: CI/CD pipelines automate dependency auditing, lockfile validation, and update workflows

## References

- [Security Auditing for Dependencies](./references/security-auditing)
- [Dependency Update Strategies](./references/update-strategies)
