---
sidebar_label: Ml System Design Interview
sidebar_position: 1
---
...
- **[Senior Coding Interview](/docs/skills/senior_coding_interview)**: Complementary skill
- **[Anthropic Technical Deep Dive](/docs/skills/anthropic_technical_deep_dive)**: Complementary skill
- **[Interview Simulator](/docs/skills/interview_simulator)**: Complementary skill

## References

- [Evaluation Metrics Guide](./references/evaluation-metrics-guide)
- [ML System Design Templates](./references/ml-design-templates)
- [Serving Architecture Tradeoffs](./references/serving-tradeoffs)
