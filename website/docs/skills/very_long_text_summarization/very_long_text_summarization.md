---
sidebar_label: Very Long Text Summarization
sidebar_position: 1
---

# ✍️ Very Long Text Summarization
...
- **[Research Craft](/docs/skills/research_craft)**: Long-text summarization supports research synthesis of academic papers and books
- **[Llm Router](/docs/skills/llm_router)**: Multi-pass summarization uses model routing to assign cheap models for extraction passes
- **[Cost Optimizer](/docs/skills/cost_optimizer)**: Hierarchical summarization of large texts requires cost-aware model selection
