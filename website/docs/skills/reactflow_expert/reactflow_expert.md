---
sidebar_label: Reactflow Expert
sidebar_position: 1
---
...
- **[Websocket Streaming](/docs/skills/websocket_streaming)**: Live DAG state updates flow through WebSocket connections to ReactFlow visualizations
- **[Human Gate Designer](/docs/skills/human_gate_designer)**: Human approval gates are rendered as interactive ReactFlow custom nodes
- **[Task Decomposer](/docs/skills/task_decomposer)**: Decomposed task DAGs are visualized as ReactFlow node graphs with ELKjs layout
