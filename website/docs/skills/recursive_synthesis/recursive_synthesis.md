---
sidebar_label: Recursive Synthesis
sidebar_position: 1
---
...
`synthesis` `multi-agent` `documents` `architecture` `constitution` `collaboration`

## 🤝 Pairs Great With

- **[Team Builder](/docs/skills/team_builder)**: Design agent teams for each phase
- **[Orchestrator](/docs/skills/orchestrator)**: Coordinate multi-phase execution

## References

- [Phase Templates: Copy-Paste Prompt Templates](./references/phase-templates)
- [Process Design: Why Recursive Synthesis Works](./references/process-design)
