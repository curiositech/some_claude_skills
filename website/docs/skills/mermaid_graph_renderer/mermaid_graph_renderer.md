---
sidebar_label: Mermaid Graph Renderer
sidebar_position: 1
---

# ✍️ Mermaid Graph Renderer
...
- **[Mermaid Graph Writer](/docs/skills/mermaid_graph_writer)**: The writer creates diagram syntax; the renderer converts it to visual SVG/PNG output
- **[Diagramming Expert](/docs/skills/diagramming_expert)**: Rendering decisions (sizing, themes, fonts) complement diagram content authoring
- **[Document Generation Pdf](/docs/skills/document_generation_pdf)**: Rendered Mermaid diagrams are embedded in generated PDF documentation
