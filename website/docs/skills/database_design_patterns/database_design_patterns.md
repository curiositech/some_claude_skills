---
sidebar_label: Database Design Patterns
sidebar_position: 1
---
...
- **[Drizzle Migrations](/docs/skills/drizzle_migrations)**: Schema design decisions are implemented through ORM migration workflows
- **[Postgresql Optimization](/docs/skills/postgresql_optimization)**: Index strategies and query patterns depend on underlying schema design choices
- **[Supabase Admin](/docs/skills/supabase_admin)**: Supabase RLS policies and schema architecture implement database design patterns

## References

- [Indexing Strategies Reference](./references/indexing-strategies)
- [Migration Patterns Reference](./references/migration-patterns)
