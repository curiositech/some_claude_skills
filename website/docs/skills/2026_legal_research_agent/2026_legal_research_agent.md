---
sidebar_label: 2026 Legal Research Agent
sidebar_position: 1
---
...
- [Clean Slate Implementation Timeline](./references/clean-slate-timeline)
- [URL Patterns by State](./references/url-patterns-by-state)
