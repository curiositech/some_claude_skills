---
sidebar_label: Clinical Diagnostic Reasoning
sidebar_position: 1
---
...
- **[Systems Thinking](/docs/skills/systems_thinking)**: Systems thinking reveals feedback loops and hidden dependencies in diagnostic reasoning chains
- **[Checklist Discipline](/docs/skills/checklist_discipline)**: Diagnostic checklists reduce cognitive bias errors in medical decision-making
- **[Crisis Detection Intervention Ai](/docs/skills/crisis_detection_intervention_ai)**: Crisis detection requires the same bias-aware reasoning used in clinical diagnostics
