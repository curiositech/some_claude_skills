---
sidebar_label: Skillful Subagent Creator
sidebar_position: 1
---
...
`skillful` `subagent` `creator` `create-subagent` `subagent-with-skills`

## 🤝 Pairs Great With

- **[Agent Creator](/docs/skills/agent_creator)**: Subagent creation applies agent design patterns to specialized DAG workflow nodes
- **[Task Decomposer](/docs/skills/task_decomposer)**: Decomposed tasks define the subagent specializations and skill requirements
- **[Skill Architect](/docs/skills/skill_architect)**: Subagent skill selection depends on understanding skill architecture and capabilities
