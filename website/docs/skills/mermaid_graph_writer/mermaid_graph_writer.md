---
sidebar_label: Mermaid Graph Writer
sidebar_position: 1
---

# ✍️ Mermaid Graph Writer
...
- **[Mermaid Graph Renderer](/docs/skills/mermaid_graph_renderer)**: The writer creates the diagram syntax that the renderer converts to visual output
- **[Diagramming Expert](/docs/skills/diagramming_expert)**: ASCII/Unicode diagramming expertise informs Mermaid syntax structure and layout decisions
- **[Technical Writer](/docs/skills/technical_writer)**: Mermaid diagrams are embedded in technical documentation to explain system architecture

## References

- [Complete Mermaid Diagram Type Reference](./references/diagram-types)
