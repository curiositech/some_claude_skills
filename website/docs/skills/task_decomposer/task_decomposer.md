...
- **[Output Contract Enforcer](/docs/skills/output_contract_enforcer)**: Decomposed tasks define output schemas that the enforcer validates between nodes
- **[Skillful Subagent Creator](/docs/skills/skillful_subagent_creator)**: Decomposed tasks map to subagent specializations with curated skill sets
- **[Human Gate Designer](/docs/skills/human_gate_designer)**: Task decomposition identifies which stages need human review gates
