---
sidebar_label: Values Behavioral Interview
sidebar_position: 1
---
...
`interview` `behavioral` `values` `anthropic` `culture-fit`

## 🤝 Pairs Great With

- **[Interview Loop Strategist](/docs/skills/interview_loop_strategist)**: Orchestrates full interview loop -- this skill handles the behavioral round
- **[Anthropic Technical Deep Dive](/docs/skills/anthropic_technical_deep_dive)**: Anthropic technical round has values overlap -- stories must be consistent
- **[Hiring Manager Deep Dive](/docs/skills/hiring_manager_deep_dive)**: HM round probes values and motivation similarly -- story bank is shared
- **[Career Biographer](/docs/skills/career_biographer)**: Upstream -- extracts raw career stories that get shaped for behavioral rounds
- **[Interview Simulator](/docs/skills/interview_simulator)**: Runs mock behavioral interviews with realistic follow-up pressure

## References

- [Anthropic Values Research](./references/anthropic-values-research)
- [Follow-Up Drills](./references/follow-up-drills)
- [Story Bank Template](./references/story-bank-template)
