...
- **[Munger Worldly Wisdom](/docs/skills/munger_worldly_wisdom)**: Systems thinking is a core mental model in Munger latticework of worldly wisdom
- **[Checklist Discipline](/docs/skills/checklist_discipline)**: Systems analysis identifies which process failure points most benefit from checklist intervention
- **[Clinical Diagnostic Reasoning](/docs/skills/clinical_diagnostic_reasoning)**: Diagnostic reasoning chains involve feedback loops and systemic interactions
- **[Research Craft](/docs/skills/research_craft)**: Systems mapping complements research methodology for analyzing complex phenomena
