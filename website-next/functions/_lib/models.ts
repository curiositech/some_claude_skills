...
export const MODEL_CATALOG: ModelInfo[] = [
  ...
  m({
    ...
    tier: "best",
    reasoning: true,
    note: "Frontier-class open model (262K ctx, function calling). Strong instruction following + spatial layout.",
  }),
  m({
    ...
    tier: "premium",
    reasoning: true,
    note: "120B MoE with only 12B active — big-model quality at sparse-model speed. Function calling.",
  }),
  m({
    ...
    outPrice: 2.253,
    tier: "premium",
    note: "70B dense on the fast serving tier. Excellent instruction following; no vision.",
  }),
  m({
    ...
    tier: "value",
    reasoning: true,
    note: "GLM's speed tier — near-Scout price with stronger structured output. Function calling.",
  }),
  m({
    ...
    tier: "mid",
    recommended: true,
    note: "DEFAULT: bake-off winner — best spatial composition of any model that beats the inference timeout. Function calling, 128K context. No vision.",
  }),
  m({
    ...
    tier: "mid",
    vision: true,
    note: "Sparse MoE (4B active): cheap, fast, vision + function calling.",
  }),
  m({
    ...
    tier: "premium",
    vision: true,
    note: "Meta flagship, multimodal MoE (16 experts), 131K context. Fast + vision, but composes weak figures (bake-off runner-up).",
  }),
  m({
    id: "@cf/qwen/qwq-32b",
    reasoning: true,
